...
module testAppSettings './appsettings.bicep' = {
  ...
  params: {
    ...
    appSettings: {
      ...
      'GoogleRecaptcha:SiteKey': '@Microsoft.KeyVault(VaultName=${vaultName};SecretName=GoogleRecaptcha-SiteKey)'
      'GoogleRecaptcha:SecretKey': '@Microsoft.KeyVault(VaultName=${vaultName};SecretName=GoogleRecaptcha-SecretKey)'
