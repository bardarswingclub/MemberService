...
module testAppSettings './appsettings.bicep' = {
  ...
  params: {
    ...
    appSettings: {
      ...
      'GoogleRecaptcha:SiteKey': '@Microsoft.KeyVault(VaultName=${vaultName};SecretName=Vipps-SubscriptionKey)'
      'GoogleRecaptcha:SecretKey': '@Microsoft.KeyVault(VaultName=${vaultName};SecretName=GoogleRecaptcha-SiteKey)'
      'Vipps:MerchantSerialNumber': '@Microsoft.KeyVault(VaultName=${vaultName};SecretName=GoogleRecaptcha-SecretKey)'
