...
namespace MemberService.Data.Migrations
{
    ...
    [Migration("20260402200241_AddLastObservedAt")]
    partial class AddLastObservedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemberService.Data.EventCommunication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MemberService.Data.EventCommunicationRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("EventCommunicationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EventCommunicationId");

                    b.HasIndex("RecipientUserId");

                    b.ToTable("EventCommunicationRecipients");
                });
            ...
            modelBuilder.Entity("MemberService.Data.EventOrganizer", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("EventOrganizersHistory");
                                ttb
            ...
            modelBuilder.Entity("MemberService.Data.Inventory.InventoryAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("CurrentBorrowId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MemberService.Data.Inventory.InventoryBorrow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InventoryBorrows");
                });

            modelBuilder.Entity("MemberService.Data.Inventory.InventoryBorrowItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BorrowId", "AssetId")
                        .IsUnique();

                    b.ToTable("InventoryBorrowItems");
                });
            ...
            modelBuilder.Entity("MemberService.Data.SemesterRole", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("SemesterRolesHistory");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("MemberService.Data.EventCommunicationRecipient", b =>
                {
                    b.HasOne("MemberService.Data.EventCommunication", "EventCommunication")
                        .WithMany("Recipients")
                        .HasForeignKey("EventCommunicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MemberService.Data.User", "RecipientUser")
                        .WithMany()
                        .HasForeignKey("RecipientUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EventCommunication");
            ...
            modelBuilder.Entity("MemberService.Data.Inventory.InventoryAsset", b =>
                {
                    b.HasOne("MemberService.Data.Inventory.InventoryBorrow", "CurrentBorrow")
                        .WithMany("HeldAssets")
                        .HasForeignKey("CurrentBorrowId")
            ...
            modelBuilder.Entity("MemberService.Data.Inventory.InventoryBorrow", b =>
                {
                    b.HasOne("MemberService.Data.User", "BorrowedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MemberService.Data.Inventory.InventoryBorrowItem", b =>
                {
                    b.HasOne("MemberService.Data.Inventory.InventoryAsset", "Asset")
                        .WithMany("BorrowItems")
                        .HasForeignKey("AssetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MemberService.Data.Inventory.InventoryBorrow", "Borrow")
                        .WithMany("Items")
